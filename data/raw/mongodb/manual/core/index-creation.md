...
Do *not* use [`killOp`](/docs/manual/reference/command/killOp#mongodb-dbcommand-dbcmd.killOp) to terminate an in-progress index builds in replica sets or sharded clusters.
