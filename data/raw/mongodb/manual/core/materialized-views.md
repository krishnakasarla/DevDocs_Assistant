...
2. Navigate to the collection
   ...
   In the left navigation pane, select the sample\_training database.
...
The example uses the `movies` collection from the [sample\_mflix](https://www.mongodb.com/docs/atlas/sample-data/sample-mflix/) dataset. To learn how to load sample data, see [Load Sample Data.](https://www.mongodb.com/docs/atlas/sample-data/#std-label-load-sample-data)
