...
- A CMK (Customer Master Key) hosted on Google Cloud Key Management Service.

- A client application that inserts documents with encrypted fields using your CMK (Customer Master Key).
...
[Complete Java Application](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/java/gcp/reader/)

[Complete Node.js Application](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/node/gcp/reader/)

[Complete Python Application](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/python/gcp/reader/)

[Complete C# Application](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/dotnet/gcp/reader/CSFLE/)

[Complete Go Application](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/go/gcp/reader/)

## Set Up the KMS

1. Register a GCP Service Account

   Register or log into your existing account on [Google Cloud](https://cloud.google.com)
...
2. Create a GCP Customer Master Key
...
2. Create a Data Encryption Key
   ...
   **Tip: Attached Service Account**
   ...
   If you are using an [attached service account](https://cloud.google.com/iam/docs/impersonating-service-accounts#binding-to-resources), you can allow it to automatically authenticate it to your GCP KMS.

   To automatically authenticate, assign an empty map instead of one that contains your GCP credentials, as shown in the following code:
   ...
   Unless you're using an attached service account or an access token, add the service account credentials to your CSFLE-enabled client, as shown in the following code example. To learn about all supported credential forms for GCP, see [kmsProviders Object.](/docs/manual/core/queryable-encryption/fundamentals/kms-providers#std-label-qe-kms-provider-object-gcp)
   ...
   **Tip:**
   ...
   You saved a file containing your service account key credentials in the [Create a GCP Service Account](/docs/manual/core/csfle/tutorials/gcp/gcp-automatic#std-label-gcp-register-account) step of this guide.

   If you downloaded your credentials in JSON format, you can use the following command to extract the value of your private key, substituting `<credentials-filename>` with the name of your credentials file. The following command requires that you install [OpenSSL:](https://docs.openssl.org/master/)
   ...
   1. Add Your Key Information

      **Tip:**

      You recorded your Customer Master Key details in the [Create a Customer Master Key](/docs/manual/core/csfle/tutorials/gcp/gcp-automatic#std-label-gcp-create-master-key) step of this guide.
   ...
   2. Generate your Data Encryption Key

      Generate your Data Encryption Key using the variables declared in [step one](/docs/manual/core/csfle/tutorials/gcp/gcp-automatic#std-label-csfle-gcp-create-index) of this tutorial.
   ...
   **Tip: Learn More**
   ...
   To view a diagram showing how your client application creates your Data Encryption Key when using an Google Cloud Key Management Service, see [Architecture.](/docs/manual/core/queryable-encryption/fundamentals/kms-providers#std-label-qe-fundamentals-kms-providers-gcp-architecture)

   To learn more about the options for creating a Data Encryption Key encrypted with a Customer Master Key hosted in Google Cloud Key Management Service, see [kmsProviders Object](/docs/manual/core/queryable-encryption/fundamentals/kms-providers#std-label-qe-kms-provider-object-gcp) and [dataKeyOpts Object.](/docs/manual/core/queryable-encryption/fundamentals/kms-providers#std-label-qe-kms-datakeyopts-gcp)

   To view the complete code for making a Data Encryption Key, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/java/gcp/reader/src/main/java/com/mongodb/csfle/MakeDataKey.java)
...
3. Configure the MongoClient
   ...
   **Tip:**
   ...
   To view the complete code for this file, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/java/gcp/reader/src/main/java/com/mongodb/csfle/InsertEncryptedDocument.java)
   ...
   **Tip: Add Your Data Encryption Key Base64 ID**
   ...
   Make sure to update the following code to include your Base64 DEK (Data Encryption Key) ID. You received this value in the [Generate your Data Encryption Key](/docs/manual/core/csfle/tutorials/gcp/gcp-automatic#std-label-csfle-gcp-create-dek) step of this guide.
...
4. Insert a Document with Encrypted Fields
   ...
   To view the complete code for inserting a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/java/gcp/reader/src/main/java/com/mongodb/csfle/InsertEncryptedDocument.java)

5. Retrieve Your Document with Encrypted Fields

   Retrieve the document with encrypted fields you inserted in the [Insert a Document with Encrypted Fields](/docs/manual/core/csfle/tutorials/gcp/gcp-automatic#std-label-csfle-gcp-insert) step of this guide.
   ...
   To view the complete code for finding a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/java/gcp/reader/src/main/java/com/mongodb/csfle/InsertEncryptedDocument.java)
...
2) Create a Data Encryption Key
   ...
   **Tip: Learn More**
   ...
   To view the complete code for making a Data Encryption Key, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/node/gcp/reader/make_data_key.js)
...
3) Configure the MongoClient
   ...
   **Tip:**
   ...
   To view the complete code for this file, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/node/gcp/reader/insert_encrypted_document.js)
...
4) Insert a Document with Encrypted Fields
   ...
   To view the complete code for inserting a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/node/gcp/reader/insert_encrypted_document.js)
...
5) Retrieve Your Document with Encrypted Fields
   ...
   To view the complete code for finding a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/node/gcp/reader/insert_encrypted_document.js)
...
2. Create a Data Encryption Key
   ...
   **Tip: Learn More**
   ...
   To view the complete code for making a Data Encryption Key, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/python/gcp/reader/make_data_key.py)
...
3. Configure the MongoClient
   ...
   **Tip:**
   ...
   To view the complete code for this file, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/python/gcp/reader/insert_encrypted_document.py)
...
4. Insert a Document with Encrypted Fields
   ...
   To view the complete code for inserting a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/python/gcp/reader/insert_encrypted_document.py)
...
5. Retrieve Your Document with Encrypted Fields
   ...
   To view the complete code for finding a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/python/gcp/reader/insert_encrypted_document.py)
...
2) Create a Data Encryption Key
   ...
   **Tip: Learn More**
   ...
   To view the complete code for making a Data Encryption Key, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/dotnet/gcp/reader/CSFLE/MakeDataKey.cs)
...
3) Configure the MongoClient
   ...
   **Tip:**
   ...
   To view the complete code for this file, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/dotnet/gcp/reader/CSFLE/InsertEncryptedDocument.cs)
...
4) Insert a Document with Encrypted Fields
   ...
   To view the complete code for inserting a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/dotnet/gcp/reader/CSFLE/InsertEncryptedDocument.cs)
...
5) Retrieve Your Document with Encrypted Fields
   ...
   To view the complete code for finding a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/dotnet/gcp/reader/CSFLE/InsertEncryptedDocument.cs)
...
2. Create a Data Encryption Key
   ...
   **Tip: Learn More**
   ...
   To view the complete code for making a Data Encryption Key, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/go/gcp/reader/make-data-key.go)
...
3. Configure the MongoClient
   ...
   **Tip:**
   ...
   To view the complete code for this file, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/go/gcp/reader/insert-encrypted-document.go)
...
4. Insert a Document with Encrypted Fields
   ...
   **Note:**
   ...
   To view the complete code for inserting a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/go/gcp/reader/insert-encrypted-document.go)
...
5. Retrieve Your Document with Encrypted Fields
   ...
   To view the complete code for finding a document with encrypted fields, see [our Github repository.](https://github.com/mongodb/docs/tree/main/content/manual/upcoming/source/includes/generated/in-use-encryption/csfle/go/gcp/reader/insert-encrypted-document.go)
